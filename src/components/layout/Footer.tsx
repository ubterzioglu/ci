    ...
    <footer className="bg-charcoal text-ivory mt-auto">
      <div className="container-editorial py-14">
        ...
        <div className="text-ivory/45 mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-center text-[10px]">
          <span><a href="https://tekhurdametal.com/istanbul-hurdaci/" rel="dofollow" className="hover:text-ivory transition-colors">İstanbul Hurdacı</a> Firması Tek Hurda Metal A.Ş</span>
          ...
          <span><a href="https://tekhurdametal.com/hurda-demir-fiyatlari/" rel="dofollow" className="hover:text-ivory transition-colors">Demir Hurda Fiyatları</a> Tek Hurda Metal</span>
          <span><a href="https://tekhurdametal.com/beylikduzu-hurdaci/" rel="dofollow" className="hover:text-ivory transition-colors">Beylikdüzü Hurdacı</a> Firması Tek Hurda Metal A.Ş</span>
          <span><a href="https://lionerotik.com/urunler/fetis-urunleri" rel="dofollow" className="hover:text-ivory transition-colors">Antalya Sex Shop</a> Lion Erotik</span>
          <span><a href="https://lionerotik.com/urunler/fetis-urunleri" rel="dofollow" className="hover:text-ivory transition-colors">Antalya Erotik Shop</a> Lion Erotik</span>
          <span><a href="https://lionerotik.com/urunler/fetis-urunleri" rel="dofollow" className="hover:text-ivory transition-colors">Antalya Seks Shop</a> Lion Erotik</span>
        </div>
      </div>
    </footer>
  );
